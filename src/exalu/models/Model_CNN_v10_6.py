...
class CNet_v10_6(nn.Module):
    # 10_5's version adding fold
    def __init__(self, batch_size, output_dim=1):
        super(CNet_v10_6, self).__init__()
        ...
        self.conv.append(nn.Conv1d(5, 64, kernel_size=11))
    ...
    # def forward(self, x):
        ...
        ss_score_expanded = ss_score_expanded.expand(-1, 1, 950)
