...
MAX_LEN = 400
 ...
 # test 5k surronding regions

class CNet_v8(nn.Module):
    def __init__(self, batch_size, output_dim=1):
        super(CNet_v8, self).__init__()
        ...
        self.conv.append(nn.Conv1d(4, 64, kernel_size=19))
        ...
        self.conv.append(nn.Conv1d(512, 1024, kernel_size=3))
        self.bnc.append(nn.BatchNorm1d(1024))
        self.pool.append(nn.AvgPool1d(7))
        # self.pool.append(nn.AvgPool1d(5))
        # self.conv.append(nn.Conv1d(1024, 2048, kernel_size=3))
