...
class FCN_v1(nn.Module):
    def __init__(self, batch_size, output_dim=1):
        ...
        self.conv.append(nn.Conv1d(4, 128, kernel_size=8, padding='same'))
        self.bnc.append(nn.BatchNorm1d(128))

        self.conv.append(nn.Conv1d(128, 256, kernel_size=5, padding='same'))
        self.bnc.append(nn.BatchNorm1d(256))
        
        self.conv.append(nn.Conv1d(256, 128, kernel_size=3, padding='same'))
        self.bnc.append(nn.BatchNorm1d(128))
