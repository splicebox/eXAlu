...
if __name__ == "__main__":
    ...
    if args.input_mode == 'bed':
        if args.t == 'substitution':
            ...
            gen_saturation_mutagenesis_graphs_deletion(work_dir=args.o, model_wts_name=args.m, ks=args.k, genome=args.r, alu_bed_file=args.b, plot_mode=args.yaxis, has_peaks=args.p)

    if args.input_mode == 'fasta':
        if args.t == 'substitution':
            gen_saturation_mutagenesis_graphs_substitution(work_dir=args.o, model_wts_name=args.m, alu_fa_file=args.f, plot_mode=args.yaxis, has_peaks=args.p)
        elif args.t == 'deletion':
            gen_saturation_mutagenesis_graphs_deletion(work_dir=args.o, model_wts_name=args.m, ks=args.k, alu_fa_file=args.f, plot_mode=args.yaxis, has_peaks=args.p)
